    ...
    return (
        <div className="page home">
            ...
            <List>
                ...
                <Item subtitle="Uploader" icon="horizontal" onClick={()=>{Tools.linkTo("/data-entry/uploader")}}>上传预览</Item>
            </List>
            ...
            <List>
                ...
                <Item subtitle="Number" icon="horizontal" onClick={()=>{Tools.linkTo("/form/number")}}>数值</Item>
                <Item subtitle="Switch" icon="horizontal" onClick={()=>{Tools.linkTo("/form/switch")}}>开关</Item>
